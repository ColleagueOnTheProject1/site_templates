...
изменения
-добавил выравнивание правого края по сетке
*/
;
(function ($, undefined) {
    "use strict";
    ...
    $.fn.lightSlider = function (options) {
        ...
        plugin = {
            ...
            initialStyle: function () {
				...
				/*добавил выравнивание правого края по сетке*/
				if(settings.item > 1)
					$slide.width($slide.width() + ($slide.parent().width() - $el.find(".item").outerWidth()*settings.item)/(settings.item - 1));
